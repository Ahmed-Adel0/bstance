...
const faqs = [
  // ── RAFFLE ──────────────────────────────────────────────
  {
    ...
    answer: (
      <>
        ...
        Volt من اختيارك: بروتين أو كارب أو كرياتين.
        <br />
        <br />
        ...
        الأعلى بنفس المبلغ الذي دفعته. مثال: اشتركت بالشهرية (600 ج.م) وفزت
  ...
  },
  {
    ...
    answer:
      "الأمر بسيط جداً: احجز أي خدمة أو باقة خلال الفترة من 12 لـ 26 رمضان — ستدخل السحب تلقائياً بدون أي خطوات إضافية. كلما حجزت أكثر، ارتفعت فرصتك. النتائج تُعلَن 27 رمضان يوم الافتتاح الرسمي.",
  },
  {
    category: "raffle",
    icon: "🤔",
  ...
  },
  {
    ...
    answer:
      "فترة السحب من 12 رمضان حتى 26 رمضان (14 يوماً). النتائج تُعلَن في 27 رمضان يوم الافتتاح الرسمي لـ B•Stance. يُنصح بالحجز مبكراً لضمان تسجيل تذكرتك.",
  },
  ...
  // ── HIJAMA ──────────────────────────────────────────────
  {
    ...
    answer:
      "نعم، الحجامة في B•Stance تتم وفق أعلى معايير السلامة الطبية. كل الكاسات أحادية الاستخدام وتُفتَح أمامك مباشرة قبل الجلسة. المشرط معقم ومعبأ، السطح والأيدي مُعقَّمة قبل وبعد كل جلسة. الفريق مُدرَّب ومعتمد على هذه البروتوكولات.",
  },
  {
    category: "hijama",
    icon: "🩸",
  ...
  // ── GENERAL ──────────────────────────────────────────────
  {
    ...
    answer:
      "نقبل الدفع نقداً في الفرع، أو تحويل بنكي، أو عبر المحافظ الإلكترونية. يمكنك الحجز الآن وترتيب طريقة الدفع مع فريقنا عبر واتساب.",
  },
  {
    category: "general",
    icon: "📍",
    ...
    answer:
      "B•Stance موجود في القاهرة. بعد الحجز عبر الموقع، سيتواصل معك فريقنا على واتساب لتأكيد الموعد والعنوان التفصيلي. الحجز لا يلزمك بأي شيء — الفريق هيرتب معك كل التفاصيل.",
  },
];
