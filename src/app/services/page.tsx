...
const services = [
  ...
  },
  {
    ...
    delivery: ["Offline"],
    description:
      "جلسات استشفاء احترافية حضورية تستخدم أحدث التقنيات لتقليل الإصابات وتسريع التعافي وتحسين الأداء على المدى البعيد.",
    features: [
      "تقييم الإرهاق والإصابات",
      "جلسات Massage وElectrotherapy",
      "برتوكول استشفاء مخصص",
      "تمارين Mobility وStretching",
      "مراقبة علامات الجسم الحيوية",
      "توصيات النوم والراحة",
    ],
    target: ["الرياضيون  فترة المنافسات والبطولات", "المصابون في مراحل التعافي", "الرياضيون المحترفون"],
    icon2: MapPin,
