...
const teamMembers = [
  {
    ...
    bio: "كوتش معتمد دولياً في التدريب الشخصي والتغذية الرياضية، يصمم برامج تدريبية مخصصة تناسب مختلف المستويات والأهداف.",
    tags: [
  ...
  },
  {
    ...
    title: "Fitness Coach & Nutrition Expert",
    image: "/imgs/sakar.jpg",
    imagePosition: "center top",
    experience: "5+",
    experienceLabel: "سنوات خبرة",
    bio: "خبير لياقة بدنية وتغذية رياضية بخبرة ميدانية متعددة السنوات، متخصص في بناء الجسم والقدرة البدنية للرياضيين والمبتدئين على حد سواء.",
    tags: [
      { icon: "🏋️", label: "Fitness Coaching" },
      { icon: "🥩", label: "Nutrition Planning" },
