...
const steps = [
  {
    num: "01",
    icon: User,
    title: "التقييم الرقمي والتشخيص",
    desc: "تبدأ رحلتك بتقييم شامل (InBody + تقييم حركي) لتحديد 'البصمة الرياضية' الخاصة بك.",
    color: "green",
    details: ["تحليل InBody دقيق", "تقييم مستوى اللياقة", "تحديد الأهداف الطبية والرياضية"],
  },
  {
    num: "02",
    icon: LayoutDashboard,
    title: "تصميم 'نظام التشغيل' الخاص بك",
    desc: "يقوم فريقنا من الأطباء والمدربين ببناء خطة التدريب والتغذية المتكاملة (OS) الخاصة بك.",
    color: "blue",
    details: ["خطة تدريب ذكية", "نظام غذائي مخصص", "جدول جلسات الاستشفاء"],
  },
  {
    num: "03",
    icon: Dumbbell,
    title: "التنفيذ المرن (Hybrid Model)",
    desc: "اختر أسلوبك: تمرن 'أونلاين' في منزلك، أو 'حضورياً' في أقرب جيم شريك لبيستانس مع مدربينا.",
    color: "yellow",
    details: ["تدريب أونلاين متكامل", "تدريب حضوري (Partner Gyms)", "إشراف من سفراء بيستانس"],
  },
  {
    num: "04",
    icon: Heart,
    title: "الاستشفاء والرعاية الاحترافية",
    desc: "توجيهك لأقرب ذراع استشفائي لبيستانس (مركزنا الرئيسي أو جيم شريك) لجلسات الريكافري والحجامة.",
    color: "green",
    details: ["جلسات ريكافري عميقة", "حجامة رياضية متخصصة", "متابعة تطور الأنسجة العضلية"],
  },
  {
    num: "05",
    icon: BarChart3,
    title: "المتابعة والتحكم المركزي",
    desc: "كل بياناتك مسجلة في منصة بيستانس. نراقب تطورك ونعدل الخطط دورياً لضمان النتائج.",
    color: "blue",
    details: ["تقارير أداء دورية", "تعديل لحظي للمسار", "مركزية البيانات (Results Dashboard)"],
  },
];
