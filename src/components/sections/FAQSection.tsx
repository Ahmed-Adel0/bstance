...
const faqs = [
  // ── RAFFLE ──────────────────────────────────────────────
  {
    category: "raffle",
    icon: "🎁",
    question: "إيه هو سحب مكملات Volt وإزاي أشارك؟",
    answer: (
      <>
        <strong style={{ color: "var(--gold)" }}>سحب Volt</strong> مخصص
        لأصحاب الجلسات الفردية فقط (ريكافري، حجامة، تغذية، تدريب).
        <br /><br />
        <strong style={{ color: "var(--teal-light)" }}>الجوائز:</strong>{" "}
        الفائز الأول يحصل على تجربة B•Stance كاملة لمدة شهر. الفائز الثاني
        يحصل على بروتين من إيڤولڤ (Evolve). الفائز الثالث يحصل على كرياتين 30 سرڤ من بيور جانيك (Pure Ganic). الفائز الرابع يحصل على كارب من تراكتور (Tractor).
        <br /><br />
        كل ما عليك: احجز جلسة فردية واحدة وتدخل السحب تلقائياً.
      </>
    ),
  },
  {
    category: "raffle",
    icon: "🎟️",
    question: "هل الباقات تدخل السحب؟",
    answer:
      "لا، السحب مخصص للجلسات الفردية فقط. الباقات لها قيمتها المستقلة وتشمل مميزات أكبر بكثير (تدريب + تغذية + ريكافري + متابعة يومية). كل جلسة فردية = تذكرة إضافية — كلما حجزت أكثر، زادت فرصتك.",
  },
  {
    category: "raffle",
    icon: "🤔",
    question: "إيه اللي بيحصل لو ما فزتش في السحب؟",
    answer:
      "حتى لو ما فزتش — ستحصل على كوبون خصم حصري على الجلسات والباقات ومكملات Volt. في B•Stance، مفيش حد بيخرج فاضي.",
  },
  {
    category: "raffle",
    icon: "📅",
    question: "متى يُعلَن عن الفائزين؟",
    answer:
      "يتم الإعلان عن الفائزين الـ 4 عبر صفحاتنا الرسمية يوم الافتتاح. يُنصح بالحجز مبكراً لضمان تسجيل تذكرتك.",
  },
